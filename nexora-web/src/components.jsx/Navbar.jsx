            ...
            <div className="container mx-auto px-4 py-3">
                <div className="flex flex-wrap justify-between items-center">
                    ...
                    <nav className="flex flex-wrap items-center gap-2.5 sm:gap-3 lg:gap-8 mt-4 lg:mt-0 sm:mt-0 ">
                        <Link
                            to="/"
                            className=" hover:text-emerald-400 transition duration-300 ease-in-out "
                        >
                            <House
                        ...
                        {user ? (
                            ...
                            <>
                                <Link
                                    to="/signup"
                                    className="bg-emerald-600 hover:bg-emerald-700 text-white lg:py-2 lg:px-4 py-1 px-1.5 rounded-xl flex items-center transition duration-300 ease-in-out"
                                >
                                ...
                                <Link
                                    to="/login"
                                    className="bg-gray-700 hover:bg-gray-600 text-white lg:py-2 lg:px-4 py-1 px-1.5 rounded-xl flex items-center transition duration-300 ease-in-out"
                                >
